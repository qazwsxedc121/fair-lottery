<div class="bs-callout bs-callout-danger">
 ...
 <ol>
   ...
   <li> Add the connection parameters in the <code>fair-lottery.models.db</code> namespace.
...
Two middleware functions are provided by default in the `fair-lottery.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `fair-lottery.handler` namespace to manage the enabled middleware.
